        ...
        <Grid container className="footer">
            <Grid item xs={12} md={3} className="footer-section-1">
                ...
                <div className="pl-1 pt-3">
                    <input list="search" placeholder="Search " type="search" className="search-input" />
                    <datalist id="search">
            ...
            <Grid item xs={12} md={3}>
                ...
                <ul>
                    <li><a href="https://facebook.com">Coffee Shops</a></li>
                    <li><a href="https://facebook.com">Products</a></li>
                    <li><a href="https://facebook.com">Pets and Adoptation</a></li>
                </ul>
            </Grid>
            <Grid item xs={12} md={3}>
