					...
					<div className='inner pb-4 pt-3 pr-3 pl-3 feature-container'>
						<Grid container className='d-flex flex-just-center'>
							<FeatureCard
								...
								poster={fp1}
								content='Strong taste of coffee and food served everyday. Enhanced based on their freshness and the natural nature that the best ones bring to the table.'
								route='/'
							/>
							<FeatureCard
								...
								poster={fp2}
								content="Focused on the beans' true flavor. Cherry pulped from the coffee through machine and removes the outer layer of the skin."
								route='/'
							/>
							<FeatureCard
							...
							<FeatureCard
								...
								video={petsInHouse}
								poster={fp4}
								content="Play with our joyful and loving pets while having coffee. We have a pet's area to the right and left near the entrance to maintain cleanliness. The pets are neighborhood pets ensured that they are clean and well-trained."
								route='/'
							/>
							<FeatureCard
								title='Good Ambience'
